x_original = 0 : 0.02 : 3*pi;
y_original = sin(x_original.^2);
noisy_y = y_original + 0.5 * randn(1, length(y_original)) % 0.5 is the noise amplitude 
x=con2seq(x_original); y=con2seq(noisy_y); % convert the data to a useful format
num_of_neurons = 20; 
...
saveas(gcf, 'img/gd_vs_lm_1_50_1000_noisy.png')
...
saveas(gcf, 'img/gd_vs_bfg_1_50_1000_noisy.png')
...
% subplot(3,3,9);
% postregm(cell2mat(net_out_bfg_3),y_original);
saveas(gcf, 'img/gd_vs_bfg_vs_lm_1_50_1000_noisy.png')
